  ...
  return (
    ...
    {/* Search */}
        <li className="relative">
            ...
            {/* module */}
            <div className={`w-60 h-20 -left-5 -bottom-26 bg-white dark:bg-[#1A1919] rounded-xl absolute overflow-hidden transition-all duration-300 ${inputStatus ? "opacity-100 visible translate-y-0" : "opacity-0 invisible -translate-y-7"}`}>
    ...
    {/* Notification */}
        <li className="relative group">
            ...
            <ul className="absolute w-60 h-48 py-1 px-3 -left-20 -bottom-54 rounded-xl bg-white dark:bg-[#1A1919] *:text-[#030A1B] dark:*:text-white *:line-clamp-2 grid opacity-0 invisible -translate-y-7 group-hover:translate-y-0 group-hover:opacity-100 group-hover:visible transition-all delay-300">
    ...
    {/* User */}
        <li className="relative group">
            ...
            {isLogin ? (
                <div className="absolute w-45 -left-18 -bottom-65 rounded-xl bg-white dark:bg-[#1A1919] text-[#030A1B] dark:text-white py-2 px-3 opacity-0 invisible -translate-y-7 group-hover:translate-y-0 group-hover:opacity-100 group-hover:visible transition-all delay-300">
